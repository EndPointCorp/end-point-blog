...
In my actual application I was populating the data object with API data via [vue-apollo](https://github.com/Akryum/vue-apollo) but have hard-coded the array of strings here for simplicity.
