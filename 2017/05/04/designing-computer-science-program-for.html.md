...
<div class="separator" style="clear: both; text-align: left;"><a href="/blog/2017/05/04/designing-computer-science-program-for/image-2-big.png" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" height="400" src="/blog/2017/05/04/designing-computer-science-program-for/image-2.png" width="328"/></a></div>
...
<div class="separator" style="clear: both; text-align: left;"><a href="/blog/2017/05/04/designing-computer-science-program-for/image-3-big.png" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" height="400" src="/blog/2017/05/04/designing-computer-science-program-for/image-3.png" width="324"/></a></div>
...
<div class="separator" style="clear: both; text-align: left;"><a href="/blog/2017/05/04/designing-computer-science-program-for/image-4-big.png" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" height="400" src="/blog/2017/05/04/designing-computer-science-program-for/image-4.png" width="305"/></a></div>

<div class="separator" style="clear: both; text-align: left;"><a href="/blog/2017/05/04/designing-computer-science-program-for/image-5-big.png" imageanchor="1" style="margin-left: 1em; margin-right: 1em;"><img border="0" height="353" src="/blog/2017/05/04/designing-computer-science-program-for/image-5.png" width="400"/></a></div>

Lastly, it's stated that we must

> Select one subject from the departmental list of EECS subjects

a link is provided to do so, however it brings you [here](http://www.eecs.mit.edu/academics-admissions/undergraduate-programs) and I cannot find a list of courses. I believe that this link no longer takes you to the intended location. A Google search brought up a similar page, but with a list of courses, as can be seen [here](https://www.eecs.mit.edu/academics-admissions/academic-information/subject-updates-ft-2016). So, I will pick one from that page.
...
- [6.0001: Introduction to Computer Science Programming in Python](http://catalog.mit.edu/search/?P=6.0001) : 2 parts consisting of [Introduction to Computer Science and Programming Using Python](https://www.edx.org/course/introduction-computer-science-mitx-6-00-1x-9?utm_source=OCW&utm_medium=CHP&utm_campaign=OCW) and [Introduction to Computational Thinking and Data Science](https://www.edx.org/course/introduction-computational-thinking-data-mitx-6-00-2x-5?utm_source=OCW&utm_medium=CHP&utm_campaign=OCW)
- [6.042[J]: Mathematics for Computer Science](http://catalog.mit.edu/search/?P=6.042): [Mathematics for Computer Science
...
- [6.S080: Brief Introduction to Python](https://www.eecs.mit.edu/academics-admissions/academic-information/subject-updates-ft-2016/6s080) : [A Gentle Introduction to Programming Using Python
...
- [6.01 : Introduction to EECS via Robot Sensing, Software and Control](http://catalog.mit.edu/search/?P=6.01) : [Introduction to Electrical Engineering and Computer Science I](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-01sc-introduction-to-electrical-engineering-and-computer-science-i-spring-2011/)
- [6.004: Computation Structures](http://catalog.mit.edu/search/?P=6.004) : [Computation Structures](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-004-computation-structures-spring-2009/)
- [6.006: Introduction to Algorithms](http://catalog.mit.edu/search/?P=6.006) : [Introduction to Algorithms](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/)
- [6.009: Fundamentals of Programming](http://catalog.mit.edu/search/?P=6.009) : closest I could find (based on class description), [Introduction to Computer Science and Programming Using Python](https://www.edx.org/course/introduction-computer-science-mitx-6-00-1x-9#!)
- [6.005 (6.031) Elements of Software Construction](http://web.mit.edu/6.031/www/sp17/) : [Elements of Software Construction](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-005-software-construction-spring-2016/)
- [6.033: Computer System Engineering (CI-M)](http://catalog.mit.edu/search/?P=6.033) : [Computer System Engineering](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-033-computer-system-engineering-spring-2009/)
