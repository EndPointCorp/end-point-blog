...
tags: postgresql, postgis, kml, liquid galaxy
---
...
<img src="/blog/2018/02/07/regionating-with-postgis/windfarms-dataset.png" alt="Wind turbine dataset" /><br />
...
<img src="/blog/2018/02/07/regionating-with-postgis/faults-dataset.png" alt="Faults dataset" /><br />
...
<img src="/blog/2018/02/07/regionating-with-postgis/wildfire-dataset.png" alt="Wildfire dataset" /><br />
...
playing along at home, I recommend tying [qgis](https://www.qgis.org/en/site/).
...
<img src="/blog/2018/02/07/regionating-with-postgis/regionated-turbines-example.jpg" alt="Regionated wind turbines" /><br />
...
hulls" drawn around the objects in the region, the result of PostGIS'
...
`ST_ClusterKMeans` (docs
[here](http://postgis.net/docs/manual-dev/ST_ClusterKMeans.html)), which as
you'd expect from the name, group objects using a [k-means
...
The other function I used is called `ST_ClusterDBScan` (docs
[here](http://postgis.net/docs/manual-dev/ST_ClusterDBSCAN.html)), an
...
<img src="/blog/2018/02/07/regionating-with-postgis/faults-dbscan-example.jpg" alt="Faults data, DBSCAN clustering" /><br />

<img src="/blog/2018/02/07/regionating-with-postgis/faults-kmeans-example.jpg" alt="Faults data, K-means clustering" /><br />
...
<img src="/blog/2018/02/07/regionating-with-postgis/turbines-dbscan-0.75-25.jpg" alt="Wind turbine data, DBSCAN clustering" /><br />

<img src="/blog/2018/02/07/regionating-with-postgis/turbines-kmeans-20.jpg" alt="Wind turbine data, K-means clustering" /><br />
...
<img src="/blog/2018/02/07/regionating-with-postgis/reefs-far.jpg" alt="Coral reefs, widest zoom" /><br />
...
<img src="/blog/2018/02/07/regionating-with-postgis/reefs-mid.jpg" alt="Coral reefs, mid-range zoom" /><br />

Finally, at even closer zoom levels, we see mostly the original reef data.

<img src="/blog/2018/02/07/regionating-with-postgis/reefs-close.jpg" alt="Coral reefs, closest zoom" /><br />
