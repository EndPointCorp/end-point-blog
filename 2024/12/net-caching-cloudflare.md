...
![A metallic flower-shaped sculpture in Buenos Aires, Argentina, called Floralis Genérica](/blog/2024/12/net-caching-cloudflare/metal-flower-buenos-aires.jpg)
...
![The response headers in Chrome DevTools with the cache-control header highlighted.](/blog/2024/12/net-caching-cloudflare/response-headers-chrome.jpg)
...
![The response headers in Chrome DevTools show that Cloudflare is tagging the content as "DYNAMIC".](/blog/2024/12/net-caching-cloudflare/response-headers-cf-dynamic.jpg)
...
![Adding a rule to "cache everything" by default.](/blog/2024/12/net-caching-cloudflare/cloudflare-cache-everything.jpg)
...
![Adding a rule to enforce a cache bypass on the user-dependent API endpoints.](/blog/2024/12/net-caching-cloudflare/cloudflare-cache-bypass.jpg)
...
![The "HIT" value means the request hit a cached version of the resource in the CDN.](/blog/2024/12/net-caching-cloudflare/cloudflare-cache-cf-hit.jpg)
...
![The "BYPASS" value Cloudflare will bypass cache on this URL.](/blog/2024/12/net-caching-cloudflare/cloudflare-cache-cf-bypass.jpg)
