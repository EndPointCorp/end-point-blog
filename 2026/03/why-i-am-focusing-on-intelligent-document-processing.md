...
github_issue_number: 2173
featured:
  image_url: /blog/2026/03/why-i-am-focusing-on-intelligent-document-processing/mountains.webp
date: 2026-03-27
tags:
...
![A snowy mountain towers over a clouded valley](/blog/2026/03/why-i-am-focusing-on-intelligent-document-processing/mountains.webp)
...
The vendor landscape includes names you already know: Google ([Document AI](https://cloud.google.com/document-ai)), Microsoft ([Azure Document Intelligence](https://azure.microsoft.com/en-us/products/ai-foundry/tools/document-intelligence)), Amazon ([Textract](https://aws.amazon.com/textract/)), ABBYY, UiPath, Automation Anywhere, and many more.
...
If you need help parsing through legacy or unstructured data, we can help! Don't hesitate to [send us a message](/contact/).
