...
![Transaction script example](implementing-business-logic-ddd-part-2/transaction-script.png)
...
![Concept map of the DDD patterns for implementing domain logic](implementing-business-logic-ddd-part-2/concept-map.png)
