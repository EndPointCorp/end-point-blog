...
<img alt="" border="0" id="BLOGGER_PHOTO_ID_5474988768862554114" src="/blog/2010/05/24/spree-multi-store-architecture/image-0.png" style="display:block; margin:0px auto 10px; text-align:center;cursor:pointer; cursor:hand;width: 600px;"/>
...
<a href="/blog/2010/05/24/spree-multi-store-architecture/image-1-big.png" onblur="try {parent.deselectBloggerImageGracefully();} catch(e) {}"><img alt="" border="0" id="BLOGGER_PHOTO_ID_5474988776225922114" src="/blog/2010/05/24/spree-multi-store-architecture/image-1.png" style="display:block; margin:0px auto 10px; text-align:center;cursor:pointer; cursor:hand;width: 321px; height: 400px;"/></a>
...
First, the [Spree multi-domain extension](http://github.com/railsdog/spree-multi-domain) developed by the Spree core team serves as a strong starting point. The extension migrations produce the data structure shown below, by creating a new table stores and products_stores, and adding a store_id column to the tracker (Google Analytics data) and orders table.

<a href="/blog/2010/05/24/spree-multi-store-architecture/image-2-big.png" onblur="try {parent.deselectBloggerImageGracefully();} catch(e) {}"><img alt="" border="0" id="BLOGGER_PHOTO_ID_5474988780275467810" src="/blog/2010/05/24/spree-multi-store-architecture/image-2.png" style="display:block; margin:0px auto 10px; text-align:center;cursor:pointer; cursor:hand;width: 364px; height: 365px;"/></a>
