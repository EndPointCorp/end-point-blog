...
<div style="text-align: center; clear: both; margin-bottom: 1em">
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-0.png" style="display:block; margin:0px auto 10px; text-align:center; clear:both; width: 400px; height: 317px;"/><br />
<small>A screenshot from the demo app.</small>
</div>

**1.** The first tip I came across was a recommendation to use a `for` loop instead of jQuery’s `each` method. I start off with some unoptimized code to test that loops through our products JSON object and renders the images to the page. In this case, the use of the for loop instead of each doesn’t give us a significant performance difference.
...
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-2.png" style="display:block; margin:0px auto 10px; text-align:center; width: 400px; height: 302px; clear:both"/>
...
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-3.png" style="display:block; margin:0px auto 10px; text-align:center; width: 145px; height: 400px; clear:both"/>
...
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-4.png" style="display:block; margin:0px auto 10px; text-align:center; width: 400px; height: 316px; clear:both"/>
...
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-5.png" style="display:block; margin:0px auto 10px; text-align:center; width: 400px; height: 289px; clear:both"/>
...
<img border="0" src="/blog/2011/01/jquery-tips-ecommerce/image-6.png" style="display:block; margin:0px auto 10px; text-align:center; width: 356px; height: 285px; clear:both"/>
...
<img src="https://chart.apis.google.com/chart?chxl=0:|Tip+%231|Tip+%233|Tip+%234|Tip+%236|Tip+%238&chxr=1,0,6250&chxt=x,y&chbh=a&chs=745x300&cht=bvg&chco=A2C180,3D7930&chds=0,6250,0,6250&chd=t:6200,106,258,169,154|515,21,60,45,37&chdl=Firefox+3.6|Chrome+8.0&chtt=jQuery+Performance"/>
