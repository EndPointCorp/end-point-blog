...
But is there any way to prove that out? We can actually see the environment for those old processes, and if the system had set the $TZ variable when starting up cron it should appear…
